...
class CeresAgriServiceProvider extends ServiceProvider
{
    ...
    public function boot(Twig $twig, Dispatcher $dispatcher, ConfigRepository $config)
    {
        ...
        if (in_array("item", $enabledOverrides) || in_array("all", $enabledOverrides))
        {
            ...
            {
                $container->setTemplate('CeresAgri::Item.SingleItemWrapper');
                return false;
            }, self::PRIORITY);
        }
        ...
        if (in_array("wish_list", $enabledOverrides) || in_array("all", $enabledOverrides))
        {
            ...
            {
                $container->setTemplate('CeresAgri::WishList.WishListView');
                return false;
            }, self::PRIORITY);
        }
        ...
        if (in_array("contact", $enabledOverrides) || in_array("all", $enabledOverrides))
        {
            ...
            {
                $container->setTemplate('CeresAgri::Customer.Contact');
                return false;
            }, self::PRIORITY);
        }
        ...
        if (in_array("order_return", $enabledOverrides) || in_array("all", $enabledOverrides))
        {
            ...
            {
                $container->setTemplate('CeresAgri::OrderReturn.OrderReturnView');
                return false;
            }, self::PRIORITY);
        }
        ...
        if (in_array("order_return_confirmation", $enabledOverrides) || in_array("all", $enabledOverrides))
        {
            ...
            {
                $container->setTemplate('CeresAgri::OrderReturn.OrderReturnConfirmation');
                return false;
            }, self::PRIORITY);
        }
        ...
        if (in_array("cancellation_form", $enabledOverrides) || in_array("all", $enabledOverrides))
        {
            ...
            {
                $container->setTemplate('CeresAgri::StaticPages.CancellationForm');
                return false;
            }, self::PRIORITY);
        }
        ...
        if (in_array("newsletter_opt_out", $enabledOverrides) || in_array("all", $enabledOverrides))
        {
            ...
            {
                $container->setTemplate('CeresAgri::Newsletter.NewsletterOptOut');
                return false;
            }, self::PRIORITY);
        }

        $enabledResultFields = explode(", ", $config->get("CeresAgri.result_fields.override"));
        ...
        if (in_array("auto_complete_list_item", $enabledResultFields) || in_array("all", $enabledResultFields))
        {
          ...
          {
              $templateContainer->setTemplate(ResultFieldTemplate::TEMPLATE_AUTOCOMPLETE_ITEM_LIST, 'CeresAgri::ResultFields.AutoCompleteListItem');
              return false;
          });
        }
        ...
        if (in_array("basket_item", $enabledResultFields) || in_array("all", $enabledResultFields))
        {
          ...
          {
              $templateContainer->setTemplate(ResultFieldTemplate::TEMPLATE_BASKET_ITEM, 'CeresAgri::ResultFields.BasketItem');
              return false;
          });
        }
        ...
        if (in_array("category_tree", $enabledResultFields) || in_array("all", $enabledResultFields))
        {
          ...
          {
              $templateContainer->setTemplate(ResultFieldTemplate::TEMPLATE_CATEGORY_TREE, 'CeresAgri::ResultFields.CategoryTree');
              return false;
          });
        }
        ...
        if (in_array("list_item", $enabledResultFields) || in_array("all", $enabledResultFields))
        {
          ...
          {
              $templateContainer->setTemplate(ResultFieldTemplate::TEMPLATE_LIST_ITEM, 'CeresAgri::ResultFields.ListItem');
              return false;
          });
        }
        ...
        if (in_array("single_item", $enabledResultFields) || in_array("all", $enabledResultFields))
        {
          ...
          {
              $templateContainer->setTemplate(ResultFieldTemplate::TEMPLATE_SINGLE_ITEM, 'CeresAgri::ResultFields.SingleItem');
              return false;
          });
        }
    }
